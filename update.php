    ...
    <div class="container">
          ...
          <div class="col-md-6 offset-md-3">
            ...
            <div class="card my-5">
              ...
              <form class="card-body cardbody-color p-lg-5" method="POST" >
                ...
                <br>
                <div class="text-center"><a href="admin.php">Admin Control Panel</a></div>
                </div>
              </form>
            </div>
        ...
        <?php
          if(isset($_POST['update']))
          {
             ...
             $update="update login_details set name='$name',address='$address',pincode='$pincode',state='$state',city='$city',phoneno='$phone',email='$email',userid='$userid',password='$password' where id='$id'";
