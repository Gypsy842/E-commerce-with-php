    ...
    <div class="container">
        ...
        <?php
          if(isset($_POST['update']))
          {
             ...
             $update="update login_details set name='$name1',address='$address1',pincode='$pincode1',state='$state1',city='$city1',phoneno='$phone1',email='$email1',userid='$userid1',password='$password1' where `login_details`.`userid`='$id'";
