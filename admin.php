    ...
    <table class="table table-bordered">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><button class="btn btn-warning"><a href="update.php?rn=<?php echo $data['id']?>">Edit</a></button></td>
                    <td><button class="btn btn-danger"><a href='delete.php?rn=<?php echo $data['id']?>'>Delete</button></a></td>
